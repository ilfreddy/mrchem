...
void driver::build_fock_operator(const json &json_fock, Molecule &mol, FockOperator &F, int order) {
    ...
    if (json_kinzora != json_fock.end()) {
        ...
        auto kappa_inv = std::make_shared<ZoraOperator>(nuclei, proj_prec, smooth_prec, shared_memory, 2);
        auto grad_ln_kappa = std::make_shared<GradLnKappaOperator>(D_p, ln_kappa);
        F.getKappaInvOperator() = kappa_inv;
        F.getGradLnKappaOperator() = grad_ln_kappa;
    }
    ///////////////////////////////////////////////////////////
    //////////////////   Nuclear Operator   ///////////////////
    ///////////////////////////////////////////////////////////
