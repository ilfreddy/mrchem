 ...
 */
ComplexMatrix ZoraKineticOperator::operator()(OrbitalVector &bra, OrbitalVector &ket) {
 ...
 * NOT IMPLEMENTED
 */
ComplexMatrix ZoraKineticOperator::dagger(OrbitalVector &bra, OrbitalVector &ket) {
