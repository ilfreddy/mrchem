 ...
 */
ComplexMatrix NRKineticOperator::operator()(OrbitalVector &bra, OrbitalVector &ket) {
 ...
 * NOT IMPLEMENTED
 */
ComplexMatrix NRKineticOperator::dagger(OrbitalVector &bra, OrbitalVector &ket) {
